...
%patch -P 6 -p1
pushd ..
cp -a zstd-1.5.6 build32
popd
pushd ..
cp -a zstd-1.5.6 buildavx2
popd
pushd ..
cp -a zstd-1.5.6 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736374180
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libzstd.so.1.5.6
/V4/usr/lib64/libzstd.so.1.5.6
